...
extension Date {
  ...
  func timeInMinutesSinceMidnight() -> Int {
    ...
    return Int(self.timeIntervalSince1970 - cal.startOfDay(for: self).timeIntervalSince1970)
      / DateConstants.secondsPerMinute
  }

  static func findPreviousInterval(_ minutesFromMidnight: Int) -> Int {
    return self.findNearestInterval(minutesFromMidnight) - DateConstants.intervalSize
  }
